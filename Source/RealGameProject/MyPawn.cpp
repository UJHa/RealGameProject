...
AMyPawn::AMyPawn()
{
	...
	OutvisibleComponent = CreateDefaultSubobject<UStaticMeshComponent>(TEXT("OurVisibleComponent"));
	OutvisibleComponent->SetupAttachment(RootComponent);
}
...
void AMyPawn::Tick(float DeltaTime)
{
	...
	{
		float CurrentScale = OutvisibleComponent->GetComponentScale().X;
		if (bGrowing)
		{
		...
		OutvisibleComponent->SetWorldScale3D(FVector(CurrentScale));
	}
