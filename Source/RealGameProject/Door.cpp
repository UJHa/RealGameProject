...
void ADoor::BeginPlay()
{
	...
	UE_LOG(LogTemp, Log, TEXT("OriginRotation %s"), *OriginRotation.ToString());
...
void ADoor::Open()
{
	...
	UE_LOG(LogTemp, Log, TEXT("open rotation %s"), *rotation.ToString());
...
void ADoor::Close()
{
	...
	FRotator rotation = GetActorRotation();
	UE_LOG(LogTemp, Log, TEXT("close rotation %s"), *rotation.ToString());
